...
while (soldOut == false)
{
    ...
    else if (chosenOption >= 0 && chosenOption <= itemName.Length - 1)
    {
        Console.Clear();
        ...
        while (buying == true)
        {
            ...
            if (itemQuantity[chosenOption] != 0)
            {
                ...
                else
                {
                    ...
                    System.Console.WriteLine($"You can't afford that! You are ${-money + itemPrice[chosenOption] * chosenQuantity} short...");
                    AskBuy(money);
                }
            }
        }
